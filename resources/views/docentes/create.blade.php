...
@section('content_header')
    <h1><i class="fas fa-user-plus"></i> Crear Docente</h1>
@stop
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nombre1" id="nombre" class="form-control" placeholder="Ingrese el primer nombre" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="apellidop" id="apellidop" class="form-control" placeholder="Ingrese el apellido paterno" required>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="dni" id="dni" class="form-control" placeholder="Ingrese el número de cédula o pasaporte" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div id="preview-container" class="text-center mt-3">
                                <img id="preview-image" src="#" alt="Vista previa" 
                                    style="display: none; max-width: 60%; max-height: 100px; object-fit: cover; border-radius: 10px; border: 1px solid #ddd;" />
                            </div>
                        </div>
                    </div>
                </div>
