{{-- filepath: resources/views/alumnos/partials/contacto_emergencia_form.blade.php --}}
...
<div class="row g-3 py-3 bg-light rounded align-items-end">
    <div class="col-md-4">
        ...
        <input type="text" id="contacto_apellidos" name="contacto_apellidos" class="form-control"
            ...
            value="{{ old('contacto_apellidos', $alumno->contacto_apellidos ?? '') }}">
    </div>
    <div class="col-md-3">
        ...
        <input type="text" id="contacto_nombres" name="contacto_nombres" class="form-control"
            ...
            value="{{ old('contacto_nombres', $alumno->contacto_nombres ?? '') }}">
    </div>
    <div class="col-md-2">
        ...
        <input type="text" id="contacto_parentesco" name="contacto_parentesco" class="form-control"
            ...
            value="{{ old('contacto_parentesco', $alumno->contacto_parentesco ?? '') }}">
    </div>
    <div class="col-md-3">
        ...
        <input type="tel" id="contacto_telefono" name="contacto_telefono" class="form-control"
            ...
            value="{{ old('contacto_telefono', $alumno->contacto_telefono ?? '') }}">
    </div>
    <div class="col-md-3">
        ...
        <input type="tel" id="contacto_celular" name="contacto_celular" class="form-control"
            ...
            value="{{ old('contacto_celular', $alumno->contacto_celular ?? '') }}">
    </div>
</div>
